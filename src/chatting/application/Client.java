...
public class Client  implements ActionListener {
    ...
    Client(){
        ...
        p1.setBackground(new Color(184,20,222));
        p1.setBounds(0, 0, 450, 70);
        p1.setLayout(null);
        f.add(p1);

        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("left_arrow.png"));
        Image i2 = i1.getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel back = new JLabel(i3);
        back.setBounds(5,23,20,20);
        p1.add(back);
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("2.jpg"));
        ...
        send.setBackground(new Color(184,20,222));
